                            ...
                            <tbody>
                               {
                                   orders.map((order, index) =>  <tr key={order._id}>
                                    ...
                                    <td>{order.status}</td>
                                    <td className='d-flex justify-content-evenly'><a title='Approve' onClick={()=> handleDelete(order._id)} className='admin fs-5'><i class="bi bi-check-circle text-success"></i></a>
                                    <a title='Cancel' onClick={()=> handleDelete(order._id)} className='admin fs-5'><i class="bi bi-x-circle-fill text-danger"></i></a>
                                    </td>
                                </tr>)
                               }
                            </tbody>
